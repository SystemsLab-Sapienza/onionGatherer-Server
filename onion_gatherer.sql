...
ALTER TYPE stat OWNER TO postgres;
...
--
-- Name: onions; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE onions OWNER TO postgres;

--
-- Name: onions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE onions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE onions_id_seq OWNER TO postgres;

--
-- Name: onionsupdays; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE onionsupdays (
    url text NOT NULL,
    dateup date NOT NULL
);


ALTER TABLE onionsupdays OWNER TO postgres;
...
--
-- Name: onions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY onions
    ADD CONSTRAINT onions_pkey PRIMARY KEY (url);


--
-- Name: uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY onionsupdays
    ADD CONSTRAINT uniq UNIQUE (url, dateup);
